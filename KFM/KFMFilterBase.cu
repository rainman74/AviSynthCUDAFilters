...
KFMCudaEventPlanes *KFMCudaPlaneEventsPool::PlaneStreamStart(cudaStream_t sMain, cudaStream_t sU, cudaStream_t sV) {
    ...
    // events �̒��g��擪���猩�āAcudaEventQuery��cudaSuccess��Ԃ���̂�����΁A����𖖔��Ɉړ�����
...
__global__ void kl_copy_pad(
    vpixel_t *dst, const int dstpitch4, // 2�s����z��
    const vpixel_t *__restrict__ src, const int srcpitch4, // 2�s����z��
    const int width4, const int height,
    const int hpad4, const int vpad) {
    const int x = threadIdx.x + blockIdx.x * blockDim.x - hpad4; // 1�X���b�h4pixel
...
__global__ void kl_copy_pad_2plane(
    vpixel_t *dst0, vpixel_t *dst1, const int dstpitch4, // 2�s����z��
    const vpixel_t *__restrict__ src0, const vpixel_t *__restrict__ src1, const int srcpitch4, // 2�s����z��
    const int width4, const int height,
    const int hpad4, const int vpad) {
    const int x = threadIdx.x + blockIdx.x * blockDim.x - hpad4; // 1�X���b�h4pixel
    const int y = threadIdx.y + blockIdx.y * blockDim.y - vpad;
